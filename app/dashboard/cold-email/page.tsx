...
export default function ColdEmailPage() {
  ...
  async function handleGenerate() {
    ...
    try {
      const res = await fetch('/api/generate', {
        ...
        body: JSON.stringify({ prospectInfo, toolType: 'cold_email' })
      })
  ...
  return (
    <div className="max-w-2xl mx-auto px-8 py-12">
      <div className="mb-8">
        <p className="text-xs text-blue-400 uppercase tracking-widest mb-2 font-medium">Cold Email</p>
        <h1 className="text-2xl font-semibold tracking-tight mb-2">Write a cold email</h1>
        <p className="text-sm text-gray-400">Paste a prospect's info or LinkedIn URL to generate a personalized cold email.</p>
      </div>
      ...
      {result && (
        <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-6">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-medium text-gray-300">Your email</h2>
